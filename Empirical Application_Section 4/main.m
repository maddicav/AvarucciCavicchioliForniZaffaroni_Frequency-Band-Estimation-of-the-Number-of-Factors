%This main file reproduces results reported in Section 4 
% “Empirical Application: Dissecting the U.S. Economy”
% in “Frequency-Band Estimation of the Number of Factors”
...
clear
%-------------------------------------------------------------------------
% Load and transform the variables in FRED-QD (See Section S.4. in Avarucci
% et al 2025)
%-------------------------------------------------------------------------
LoadQ
%
