%--------------------------------------------------------------------------
% data = DGP3model(N,T,q,opt): (T x N) realization of the DGP process in
% Avarucci et al (2025), Section S.2.1 (Online Supplement), "Simulation Design: Third Experiment"
%
% 
% 
% INPUTS    'T': the time series dimension equals the number of rows.
%           'N': the cross-sectional dimension equals the number of columns.
%           q  :  number of shocks
