%--------------------------------------------------------------------------
% Data Generating Process Section S.2.2 in Avarucci et al (2025)
% Online Supplement - Simulation Design: Fourth Experiment (iii)
% Trend-Cycle Model
% 
% 
% variables = TrendCycleModel(N,T,q,s)
% INPUTS    N,T    :  panel dimension
%           q      :  number of factors/shocks
%           s      : standard deviation idiosyncratic component
% OUTPUT   data:  : (T x N) panel data (fourth experiment, Trend-Cycle Model)
