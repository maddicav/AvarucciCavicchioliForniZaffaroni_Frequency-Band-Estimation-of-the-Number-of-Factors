%-----------------------------------------------------------------------------------
%
% Output: TABLE S.5 in Avarucci et al 2025, Online Supplement 
%         Bottom Panel (large idiosyncratic compoment): set " sizeidio='LI' " - See Line 32
%         Top Panel (small idiosyncratic compoment): set " sizeidio='SI' " - See Line 33
%
% Requires: DGP3model.m, ACFZcrit.m, HLcrit, ONcrit, AHcrit
%------------------------------------------------------------------------------------
...
% ACFZcrit-> estimates 'q' using DER,DGR,DDR (Avarucci et al 2025)
